...
import styles, { COLORS } from "../../../styles/apply/masterstyle";

const COUNTRIES = [
  "Vietnam","Uzbekistan","China","Mongolia","France","United States","Japan","Russia",
  "Philippines","Indonesia","Myanmar","Bangladesh","Nepal","India","Pakistan",
  "Kazakhstan","Kyrgyzstan","Thailand","Other",
];

export default function MasterApplyFormScreen() {
    ...
    <LinearGradient colors={[COLORS.bgStart, COLORS.bgEnd]} style={styles.screen}>
      ...
      >
        <View style={styles.header}>
          ...
          <View>
            <Text style={styles.headerTitle}>Master Program Application</Text>
            <Text style={styles.headerSubtitle}>Program ID: {id} · Master</Text>
          </View>
          <View style={{ width: 40 }} />
        </View>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.sectionCard}>
            ...
            <InputField
              ...
              placeholder="Last University Attended"
              value={eduData.lastSchool}
              onChange={(t) => handleEduInput("lastSchool", t)}
            />
            <InputField
              icon="ribbon-outline"
              placeholder="Intended Major (Master)"
              value={eduData.major}
